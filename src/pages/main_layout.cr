    ...
    html lang: "en" do
      ...
      body do
        main class: "container" do
          nav class: "nav border-bottom mb-4" do
            li class: "nav-item mr-auto" do
              link "Rooms", Rooms::Index, class: "nav-link"
            end
            li class: "nav-item" do
              span "Signed in as ", class: "navbar-text"
            end
            li class: "nav-item" do
              link current_user.email, Me::Show, class: "nav-link"
            end
            li class: "nav-item" do
              link "Sign Out", SignIns::Delete, class: "nav-link"
            end
          end
